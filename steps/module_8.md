...
curl -X POST -F 'username=bobby' -F 'password=Shivam@123' http://api:8000/api-token-auth/

http post http://api:8000/api-token-auth/ username=bobby password=Shivam@123


> This will retrieve all items

curl -X GET -H 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db' http://api:8000/item/

http http://api:8000/item/ 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db'


> This will retreive a single item

curl -X GET -H 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db' http://api:8000/item/1271f21d-00f0-4fff-901a-f1ab6d10f0de/

http http://api:8000/item/1271f21d-00f0-4fff-901a-f1ab6d10f0de/ 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db'

> This will place an order for item id = **your_item_uuid** quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db' -d '{"item": "1271f21d-00f0-4fff-901a-f1ab6d10f0de", "quantity": "1"}' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db' item="1271f21d-00f0-4fff-901a-f1ab6d10f0de" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db' http://api:8000/order/**your_order_uuid**/

http http://api:8000/order/**your_order_uuid**/ 'Authorization: Token dd579e694323a72fa3bceadd4fd11a055125f6db'
